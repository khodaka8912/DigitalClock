 ...
 *
 */
public class ClockFrame extends Window implements SettingsListener {
...
//		setMenuBar(menuBar);
	...
	public static void main(String[] args) {
		ClockFrame clockFrame = new ClockFrame(new Frame());
		clockFrame.start();
	}
	...
	private class ClockMouseListener extends MouseAdapter {
        ...
        private Point dragStartPos, draggingPos, currentPos;
